...
int main()
{
    ...
    while (choise != '0')
    {
        ...
        case 1:
        {
            cout << "В этом задании программа сформаирует одномерный массив, каждый элемент которого - колилчество элементов больших данного числа соответсвующей строки матрицы." << endl;
            int c_array[cM][cN];
        ...
        case 2:
        {
            cout << "В этом задании программа выведет первый попавшийся столбцец матрицы, в котором есть повторяющиеся элементы." << endl;
            int c_array[cM][cN];
            array<array<int, cM>, cN> stl_array;
            cout << "Нажмите Y чтобы заполнить матрицу из файла" << endl;
            char choise;
        ...
        case 3:
        {
            ...
            cout << "В этом задании программа заменит все числа ниже побочной диагонали матрицы на их квадраты." << endl;
            cout << "Нажмите Y чтобы заполнить матрицу из файла" << endl;
            char choise;
            cin >> choise;
            if (tolower(choise) == 'y')
        ...
        case 4:
        {
            cout << "В этом задании программа сначала вставит последний столбец после тех столбцов, в которых все элементы положительны, а после вставит выбранную пользователем строку после всех строк, в которых все элементы отрицательны." << endl;
            size_t M,N;
            enterMN(M,N);
            vector<vector<int>> stl_vector;
            stl_vector.assign(M, vector<int>(N));
        ...
        case 5:
        {
            cout << "В данном задании программа удалит все строки, в которых есть минимальный элемент, а после удалит все стролбцы, в которых есть максималльный элемент" << endl;
            size_t M,N;
            enterMN(M,N);
            vector<vector<int>> stl_vector;
            stl_vector.assign(M, vector<int>(N));
